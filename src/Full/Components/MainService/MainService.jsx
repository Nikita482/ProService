        ...
        <>
            <div className={styles.wrapper}>
                ...
                <div className={styles.boxLinks}>
                    ...
                    <Link to='/Page7' className={styles.Link3}><div className={styles.text}>Уход за растениями</div></Link>
                    ...
                    <Link to='/Page10' className={styles.Link6}><div className={styles.text}>Уход за животными</div></Link>
                </div>
